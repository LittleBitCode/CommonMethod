...
- (void)commonInit {
    ...
    // default values
    _scrollDirection = LBAutoScrollDirectionLeft;
...
- (void)setScrollDirection:(LBAutoScrollDirection)direction {
...
- (void)scrollLabelIfNeeded {
    ...
    BOOL doScrollLeft = (self.scrollDirection == LBAutoScrollDirectionLeft);
...
- (void)applyGradientMaskForFadeLength:(CGFloat)fadeLength enableFade:(BOOL)fade {
    ...
    if (fadeLength) {
        ...
        if (!fade) switch (self.scrollDirection) {
            case LBAutoScrollDirectionLeft:
                leftFadePoint = @0;
                break;
                
            case LBAutoScrollDirectionRight:
                leftFadePoint = @0;
                rightFadePoint = @1;
                break;
        }
