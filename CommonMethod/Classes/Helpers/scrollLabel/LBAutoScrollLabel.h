...
typedef NS_ENUM(NSInteger, LBAutoScrollDirection) {
    LBAutoScrollDirectionRight,
    LBAutoScrollDirectionLeft
};

@interface LBAutoScrollLabel : UIView <UIScrollViewDelegate>

@property (nonatomic) LBAutoScrollDirection scrollDirection;
